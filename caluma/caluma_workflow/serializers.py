...
class SaveCaseSerializer(ContextModelSerializer):
    ...
    def create(self, validated_data):
        ...
        #
        # Django has never saved reverse one-to-one relation and
        # starting with version 5.2 raises an exception when passing
        # one as a param to the create method.
        # https://code.djangoproject.com/ticket/34586
